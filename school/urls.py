...
urlpatterns = [
    ...
    path('manager/<int:pk>/student/unrated/', views.manager_unrated, name='manager_unrated'),
    path('manager/<int:pk>/student/rated/', views.manager_rated, name='manager_rated'),
    ...
    path('manager/<int:pk>/tasks/', views.TaskListManager.as_view(), name="manager_tasks"),
]
