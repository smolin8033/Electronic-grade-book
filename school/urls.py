...
urlpatterns = [
    ...
    path('teacher/<int:pk>/class/rated/', views.teacher_rated, name="teacher_rated"),
    path('teacher/<int:pk>/class/all_rated/', views.teacher_all_rated, name="teacher_all_rated"),
    path('teacher/<int:pk>/class/unrated/', views.teacher_unrated, name="teacher_unrated"),
    path('teacher/<int:pk>/class/all_unrated/', views.teacher_all_unrated, name="teacher_all_unrated"),
