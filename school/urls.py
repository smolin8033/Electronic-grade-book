...
urlpatterns = [
    ...
    path('<int:pk>/class/rated/', views.teacher_rated, name="rated"),
    path('<int:pk>/class/all_rated/', views.teacher_all_rated, name="all_rated"),
    path('teacher/<int:pk>/class/unrated/', views.teacher_unrated, name="teacher_unrated"),
    path('<int:pk>/class/all_unrated/', views.teacher_all_unrated, name="all_unrated"),
    ...
    #path('manager/<int:pk>/class/rated/',)
]
